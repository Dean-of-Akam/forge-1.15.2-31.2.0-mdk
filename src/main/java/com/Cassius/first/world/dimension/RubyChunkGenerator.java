...
public class RubyChunkGenerator extends NoiseChunkGenerator<RubyGenSettings> {
    ...
    public RubyChunkGenerator(IWorld worldIn, BiomeProvider provider, RubyGenSettings settingsIn) {
