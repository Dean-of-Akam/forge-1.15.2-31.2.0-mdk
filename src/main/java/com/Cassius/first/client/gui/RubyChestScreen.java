package com.Cassius.first.client.gui;
...
public class RubyChestScreen extends ContainerScreen<RubyChestContainer> {
    ...
    private static final ResourceLocation BACKGROUND_TEXTURE = new ResourceLocation(FirstMod.MOD_ID, "textures/gui/ruby_chest.png");
    ...
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
        ...
        this.font.drawString(playerInventory.getDisplayName().getFormattedText(), 8.0f, 90.0f, 4210752);
    }
